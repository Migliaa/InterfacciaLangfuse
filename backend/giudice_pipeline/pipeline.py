...
automatico → registrazione su Langfuse. Esecutore, giudice e gateway sono iniettati: nei test
si passano fake/mock, nell'uso reale le implementazioni vere (vedi run_pipeline.py)."""
